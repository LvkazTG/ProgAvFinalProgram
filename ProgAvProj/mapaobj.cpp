...
//--------------------------------------------------------------------------------------------------
const std::shared_ptr<PointObj>& MapaObj::getPointByCoord(const uint8_t xCoord, const uint8_t yCoord) const
{
    return _points.at(PointObj::calcHash(xCoord, yCoord));
}
//--------------------------------------------------------------------------------------------------
